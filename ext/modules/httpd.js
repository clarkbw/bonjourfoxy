  ...
  if (DEBUG)
  {
    ...
    if (DEBUG_TIMESTAMP)
    {
      ...
      Components.classes["@mozilla.org/consoleservice;1"]
                ...
                .logStringMessage("DUMP --- " + prefix + str + "\n");
 ...
 */
var nsHttpServer = function nsHttpServer()
{
  if (!gThreadManager)
...
nsHttpServer.prototype =
{
  ...
  start: function(port, host)
  {
    Components.classes["@mozilla.org/consoleservice;1"]
              .getService(Components.interfaces.nsIConsoleService)
              .logStringMessage("server.start on: " + host + ":" + port);
    this._start(port, host || "localhost")
  },
...
ServerIdentity.prototype =
{
  ...
  _initialize: function(port, host, addSecondaryDefault)
  {
    ...
    if (this._primaryPort !== -1)
      ...
      this.setPrimary("http", host, port);
